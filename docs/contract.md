...
Certified cell: UE 5.8.1, changelist `56057345`, macOS arm64. Support certification is complete through P1.4.
...
- Canonical catalog contains 70 records. Generated Rust/C++ hash is `6161e017548d1e576b9bb8ecf42f75c69519b9d38e128c86c83611ff4fdd89de`; generation and every handshake enforce parity.
...
- P1.0 made generated catalog metadata authoritative for native mutation classification, preflight, receipt/readback routing, save-policy enforcement, tri-state capability availability, and startup fail-closed validation. P1.1–P1.4 implement and certify bounded Blueprint, SCS, interaction, widget, AI navigation, Blackboard, and Behavior Tree authoring/observation operations.
...
- Current Rust baseline is Rust 1.88 with 50 library tests, 6 xtask tests, and 44 real-binary integration tests = 100 tests.
...
- P1 remains active. P1.0–P1.4 are complete; P1.5–P1.6 remain not started.
