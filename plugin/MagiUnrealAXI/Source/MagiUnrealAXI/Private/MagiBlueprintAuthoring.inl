...
FString P11FailedAtomicResponse(const FString& Id, const FString& Operation, const TSharedPtr<FJsonObject>& Args, const FString& RequestedTarget, const FString& BeforeRevision, const FString& ObservedRevision, const bool RollbackVerified, const TArray<TSharedPtr<FJsonValue>>& DirtyPackages, const TCHAR* Message)
{
    ...
    FString CharacterBlueprintId, AnimationBlueprintId, StateMachineId, FromStateId, ToStateId;
    if (Args.IsValid())
    {
        ...
        Args->TryGetStringField(TEXT("characterBlueprintId"), CharacterBlueprintId); Args->TryGetStringField(TEXT("animationBlueprintId"), AnimationBlueprintId); Args->TryGetStringField(TEXT("stateMachineId"), StateMachineId); Args->TryGetStringField(TEXT("fromStateId"), FromStateId); Args->TryGetStringField(TEXT("toStateId"), ToStateId);
    }
    ...
    else if (Operation == TEXT("animation_blueprint.create")) { FString Path; if (Args.IsValid()) Args->TryGetStringField(TEXT("path"), Path); Target = Path + TEXT(".") + FPackageName::GetShortName(Path); }
    else if (Operation == TEXT("animation.character_configure")) Target = CharacterBlueprintId + TEXT("#animation-character");
    else if (Operation == TEXT("animation.state_machine_ensure")) Target = AnimationBlueprintId + TEXT("#state-machine:") + Name;
    else if (Operation == TEXT("animation.state_ensure")) Target = AnimationBlueprintId + TEXT("#") + StateMachineId + TEXT("#state:") + Name;
    else if (Operation == TEXT("animation.transition_ensure")) Target = AnimationBlueprintId + TEXT("#") + StateMachineId + TEXT("#") + FromStateId + TEXT("#") + ToStateId;
    else if (Operation == TEXT("animation.variable_ensure")) Target = AnimationBlueprintId + TEXT("#variable:") + Name;
    ...
    const FString Before = BeforeRevision.Len() == 64 ? BeforeRevision : ((Operation == TEXT("blueprint.create") || Operation == TEXT("blueprint.interface_create") || Operation == TEXT("animation_blueprint.create")) ? AbsentRevision : Sha256(Target + TEXT("\nbefore")));
    ...
    else if (Operation == TEXT("blueprint.pin_default_set")) { Bind(TEXT("blueprintId"), TEXT("requestBlueprintId")); Bind(TEXT("pinId"), TEXT("requestPinId")); const TSharedPtr<FJsonObject>* Value = nullptr; FString ValueType; double Number = 0; Args->TryGetObjectField(TEXT("value"), Value); if (Value && (*Value)->TryGetStringField(TEXT("type"), ValueType) && (*Value)->TryGetNumberField(TEXT("value"), Number)) { Verification->SetStringField(TEXT("requestValueType"), ValueType); Verification->SetNumberField(TEXT("requestValue"), Number); } }
    ...
    else if (Operation == TEXT("animation_blueprint.create")) { Bind(TEXT("path"), TEXT("requestPath")); Bind(TEXT("skeletonId"), TEXT("requestSkeletonId")); }
    else if (Operation == TEXT("animation.character_configure")) { Bind(TEXT("characterBlueprintId"), TEXT("requestCharacterBlueprintId")); Bind(TEXT("skeletalMeshId"), TEXT("requestSkeletalMeshId")); Bind(TEXT("animationBlueprintId"), TEXT("requestAnimationBlueprintId")); }
    else if (Operation == TEXT("animation.state_machine_ensure")) { Bind(TEXT("animationBlueprintId"), TEXT("requestAnimationBlueprintId")); Bind(TEXT("name"), TEXT("requestName")); }
    else if (Operation == TEXT("animation.state_ensure")) { Bind(TEXT("animationBlueprintId"), TEXT("requestAnimationBlueprintId")); Bind(TEXT("stateMachineId"), TEXT("requestStateMachineId")); Bind(TEXT("name"), TEXT("requestName")); Bind(TEXT("sequenceId"), TEXT("requestSequenceId")); }
    else if (Operation == TEXT("animation.transition_ensure")) { Bind(TEXT("animationBlueprintId"), TEXT("requestAnimationBlueprintId")); Bind(TEXT("stateMachineId"), TEXT("requestStateMachineId")); Bind(TEXT("fromStateId"), TEXT("requestFromStateId")); Bind(TEXT("toStateId"), TEXT("requestToStateId")); Bind(TEXT("expression"), TEXT("requestExpression")); }
    else if (Operation == TEXT("animation.variable_ensure")) { Bind(TEXT("animationBlueprintId"), TEXT("requestAnimationBlueprintId")); Bind(TEXT("name"), TEXT("requestName")); Bind(TEXT("type"), TEXT("requestType")); Bind(TEXT("source"), TEXT("requestSource")); }
